...
bash test_server.sh --model_path package/model/model.nb --params_path "" --model_type seg --model_name unet --deploy_device xpu --deploy_backend fastdeploy
```
...
ps aux | grep uvicorn
#### 日志如下: ####
root        8319 67.3  0.0 3144192 196096 pts/0  Sl   19:54   0:06 /opt/py310/bin/python3.10 /opt/py310/bin/uvicorn main:app --host 0.0.0.0 --port 8000 --workers 1
root        8394  0.0  0.0 214464  1280 pts/0    S+   19:54   0:00 grep --color=always uvicorn
```
...
INFO:     Started server process [8319]
...
INFO:     Uvicorn running on http://0.0.0.0:8000 (Press CTRL+C to quit)
register finished.
Load Model and Create API Cost Time: 93.12200546264648 ms
INFO:     127.0.0.1:39836 - "GET /health HTTP/1.1" 200 OK
INFO:     127.0.0.1:57558 - "POST /predict HTTP/1.1" 200 OK
INFO:     Shutting down
INFO:     Waiting for application shutdown.
INFO:     Application shutdown complete.
INFO:     Finished server process [8319]
```
